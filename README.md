...
## Алгоритм
Storage поддерживает функцию GetNextID для получения следующего числа в возрастающий последовательности. С помощью Encoder число преобразуется в слово из 10 букв в base62 алфавите, в дальнейшем это число используется как short_url.